...
if($valor == $valor_antigo){
	...
	$pdo->query("UPDATE $tabela set saida = '$saida', usuario_pgto = '$id_usuario', pago = 'Sim', valor = '$subtotal', data_pgto = curDate() where id = '$id'");
...
//LANÇAR NAS MOVIMENTAÇÕES
	$pdo->query("INSERT INTO movimentacoes set tipo = 'Entrada', movimento = 'Conta à Receber', descricao = '$descricao', valor = '$subtotal', usuario = '$id_usuario', data = curDate(), lancamento = '$saida', id_mov = '$id'");

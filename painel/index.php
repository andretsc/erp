			...
			<aside class="sidebar-left">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="./"><span class="fa fa-area-chart"></span> ERP<span class="dashboard_text">Gerenciamento</span></a></h1>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">									
									<li><a href="#" data-toggle="modal" data-target="#RelLogs"><i class="fa fa-angle-right"></i> Logs</a></li>
					...
					<div class="col-md-4">						
						<div class="form-group"> 
							...
							<select class="form-control sel2index" name="tabela" style="width:100%;">
								...
								<?php 
									$query = $pdo->query("SELECT table_name FROM information_schema.tables where table_schema = 'escritorio'");							
									$res = $query->fetchAll(PDO::FETCH_ASSOC);
